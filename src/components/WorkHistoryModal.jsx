          ...
          <form onSubmit={handleLog} className="mb-3 rounded-xl border border-slate-200 p-3">
            ...
            <div className="mt-3 flex justify-end gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-lg bg-brand px-3.5 py-1.5 text-sm font-medium text-white transition hover:bg-brand-strong disabled:cursor-not-allowed disabled:opacity-40"
              >
                <Plus size={15} />
                Add
              </button>
