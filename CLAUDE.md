...
> STILL TO COME in #5: the explicit zero-availability block with the sub-rental prompt, and in-house /
> sub-rental marking per order line with the vendor from #4.
